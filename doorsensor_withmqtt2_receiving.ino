...
//Evaulate the recieved message to do stuff
    if ((rx == "0")) //&& (vInp13 == HIGH)) //normal operations
      //if ((rx == "OpenDoor") && (vInp13 == HIGH)) //normal operations
      //  if ((rx == "True") && (vInp13 == HIGH)) //difference in home-assistant, prevent error in log
    {
      ...
      digitalWrite(ledGpioPin, 1);                              //Turn the output back off   
      //delay(500); //Let Voltage settle before resuming.  
    }

/*
  if ((rx == "1")) //&& (vInp13 == LOW))  //normal operations
  //if ((rx == "CloseDoor") && (vInp13 == LOW))  //normal operations
  //  if ((rx == "False") && (vInp13 == LOW))  //difference in home-assistant, prevent error in log
    {
      //digitalWrite(ledGpioPin, 1); //Turn the output on / close the door 
